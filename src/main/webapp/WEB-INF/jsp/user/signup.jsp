...
<body>
	...
	<section class="contents d-flex justify-content-center">
		<div class="join-box my-5">
			<h1 class="text-center pt-3">회원가입</h1>
			...
			<input type="text" id="emailInput" placeholder="이메일" class="form-control mt-3">
			<button type="button" id="joinBtn" class="btn btn-info btn-block mt-3">가입</button>
		</div>
	</section>
		...
		$(document).ready(function() {
			$("#joinBtn").on("click", function() {
				...
				$.ajax({
					...
					, success:function(data) { // response를 저장할 변수
